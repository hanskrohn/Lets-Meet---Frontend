...
const NavBar = withRouter(({ history }) => (
    ['/sign-in', '/sign-up'].includes(history.location.pathname) ?
      ...
      <Navbar style={{height: '10vh', borderRadius: '0px', marginBottom: '0px', backgroundColor: '#0177F9', boxShadow: '0 0 25px 0 rgba(0,0,0,0.4)'}}  sticky='top' variant="dark" className="d-flex justify-content-around">
            ...
            <Nav.Link style = {{height: '10vh', fontSize: '5vh', paddingTop: '1vh', color: 'black', display: 'inline-block' }} onClick={()=>history.push('/')}><i  class="glyphicon glyphicon-home"></i></Nav.Link>
            ...
            <Nav.Link style = {{height: '10vh', fontSize: '5vh', paddingTop: '1vh', color: 'black', display: 'inline-block' }} onClick={()=>history.push('/profile')}><i class="glyphicon glyphicon-user"></i></Nav.Link>
