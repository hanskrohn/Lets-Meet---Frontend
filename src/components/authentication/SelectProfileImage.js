...
import {
    ...
    image64toCanvasRef
} from '../currentUser/ReuseableUtils.js'
import './Signup.css'
...
const SelectProfileImage = connect(null, mapDispatchToProps)((props) => {
    ...
    const handleSubmit= (e) => {
        e.preventDefault()
        fetch('http://localhost:3000/addProfileImage',{
        method: 'POST',
        headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
        },
